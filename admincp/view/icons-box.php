...
<section class="section">
    <p>
        Use the following pattern to add the Boxicons icons to anywhere in your project.
        <code>&lt;i class=&quot;bx <strong>bxl-adobe</strong>&quot;&gt;&lt;/i&gt;</code> Replace the bold part with the
        below icon names.
