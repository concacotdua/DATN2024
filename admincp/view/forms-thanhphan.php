...
<section class="section">
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Thành phần biểu mẫu chung</h5>
                    ...
                    <form>
                        ...
                        <div class="row mb-3">
                            <label for="inputTime" class="col-sm-2 col-form-label">Thời gian</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="inputColor" class="col-sm-2 col-form-label">Bộ màu</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Nhiều lựa chọn</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary">Gửi Biểu mẫu</button>
                            </div>
                        </div>
