...
<section class="section">
    <p>
        Use the following pattern to add the Remix icons to anywhere in your project.
        <code>&lt;i class=&quot;<strong>ri-add-line</strong>&quot;&gt;&lt;/i&gt;</code> Replace the bold part with the
        below icon names.
